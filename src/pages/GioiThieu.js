            ...
            <div className="container">
               <div className="">
                  <p className="fst-italic"
                     style={{fontFamily:"OpenSans-Light", fontSize:"70px",color:"#bd0017"}}
                     >
                    MangoFood 
                  </p>
                  <p className="fs-5" style={{color:"#444444",marginBottom:"20px"}}>
               ...
               <div className="row">
                  ...
                  <div className="col col-12 col-md-6 ps-3 pt-4">
                     <p className="" style={{fontFamily:"OpenSans-Light", fontSize:"40px",color:"#bd0017"}}>
                       
                        tầm nhìn & hoài bão <br /> <span>thương hiệu</span>
                     </p>
                     <p className="fs-5" style={{color:"#444444",marginBottom:"12px"}}>
                     ...
                     <p className="fs-5" style={{color:"#444444",marginBottom:"12px"}}>
                        Nhân viên chuyên nghiệp, thân thiện: chúng tôi luôn tạo
                        cơ hội để nhân viên phát triển sự nghiệp cùng công ty;
                        từ đó, cùng nhau, chúng tôi phục vụ khách hàng một cách
                        tốt nhất.
                     </p>
                     <p className="fs-5" style={{color:"#444444",marginBottom:"12px"}}>
                        Thành viên tốt của cộng đồng: Chúng tôi luôn quan tâm
                        đến cộng đồng, đặc biệt là trẻ em và các gia đình; chúng
                        tôi mang đến niềm vui và làm phong phú hơn cuộc sống của
                        mọi người.
                     </p>
                  </div>
               </div>
